...
table_df = data.groupby(["District", "Property_type"], as_index=False).agg(
    Nr_of_occurences=("ID", "count"),
    Avg_apt_size=("Apt_size", "median"),
    Avg_nr_of_rooms=("Nr_of_rooms", "median"),
    Avg_nr_of_bathrooms=("Nr_of_bathrooms", "median"),
    Avg_cold_price=("Cold_price", "median"),
    Avg_cold_price_per_sqm=("Cold_price_per_sqm", "median"),
    Avg_deposit=("Deposit", "median"),
)
...
st.pydeck_chart(
    pdk.Deck(
        ...
        initial_view_state=pdk.ViewState(
            latitude=48.22680787756701, longitude=16.37895427875075, zoom=10
        ),
        layers=pdk.Layer(
            "ScatterplotLayer",
            map_df,
